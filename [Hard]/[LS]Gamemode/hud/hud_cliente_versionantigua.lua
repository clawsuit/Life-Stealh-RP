...
addEventHandler("onClientRender", getRootElement(), function()
	if not isPlayerMapVisible() then
		...
		dxDrawText("Life Steal Roleplay v1.0", 395*sx, 741*sy, 1358*sx, 314*sy, tocolor(255, 255, 255, 120), 1.00, "default", "right", "top", false, false, false, false, false)
		if hudPlayer == true then
			time = getRealTime ()
			day = time.monthday
			mes = time.month 	
			...
			if bankmoney <= "0" then
				dxDrawBorderedText("$"..bankmoney, 1090*sx, 170*sy, 200*sx + 1090*sx, 40*sy + 170*sy, tocolor(106, 159, 106, 255), tamanoletras, "pricedown", "right", "center", false, false, false, false, false)
			else
				dxDrawBorderedText("$"..bankmoney, 1090*sx, 170*sy, 200*sx + 1090*sx, 40*sy + 170*sy, tocolor(106, 159, 106, 255), tamanoletras, "pricedown", "right", "center", false, false, false, false, false)
			end
		end
